/**
 * Protection layer for the /breath-report landing (Cloudflare Pages Function).
 * BreathEase X (lungs). One of the two protected money pages on this domain.
 *
 ...
 * /breath-report) and decides what each visitor receives:
 *
